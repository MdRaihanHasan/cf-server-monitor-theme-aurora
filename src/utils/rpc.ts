...
/** A single 2-minute bucket within the one-hour latency window (already aggregated across ct/cu/cm/bd) */
...
export interface NodeStatus {
  ...
  /** One-hour latency window returned by /api/servers (30 buckets, oldest to newest), aggregated by the adapter */
