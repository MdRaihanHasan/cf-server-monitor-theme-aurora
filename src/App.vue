      ...
      <DialogContent class="max-w-xl">
        <DialogHeader>
          ...
          <DialogDescription class="leading-6">
            <p>This page cannot reach the CF Server Monitor backend.</p>
            <p>For a static (separate-origin) deployment, set the <code class="rounded bg-muted px-1.5 py-0.5 font-mono text-foreground">CORS_ALLOWED_ORIGINS</code> environment variable on the backend.</p>
          </DialogDescription>
        </DialogHeader>
        ...
        <DialogDescription class="leading-6">
          Separate multiple domains with commas, for example:
