...
interface Props {
  /** Tooltip text; the bubble is not rendered when this is empty and there is no #content slot */
  content?: string
  /** Bubble placement relative to the trigger element */
  placement?: DataTooltipPlacement
  /** Bubble width; a number is treated as px; defaults to fitting the content */
  width?: number | string
  /** Bubble height; a number is treated as px; defaults to fitting the content */
  height?: number | string
  /** Wrapper element tag, defaults to div */
  as?: string
  /** Additional classes for the wrapper element */
  class?: HTMLAttributes['class']
  /** Additional classes for the bubble */
